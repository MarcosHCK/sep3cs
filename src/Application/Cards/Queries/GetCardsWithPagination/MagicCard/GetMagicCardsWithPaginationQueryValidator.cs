...
{
 public class GetMagicCardWithPaginationQueryValidator : AbstractValidator<GetMagicCardWithPaginationQuery>
  {
    public GetMagicCardWithPaginationQueryValidator ()
      {
