...
{
 public class GetStructCardWithPaginationQueryValidator : AbstractValidator<GetStructCardWithPaginationQuery>
  {
    public GetStructCardWithPaginationQueryValidator ()
      {
