...
namespace DataClash.Application.IntegrationTests.Clans.Queries
{
  ...
  public class GetPlayerClansWithPaginationTests : BaseTestFixture
    {
      [Test]
      public async Task ShouldRequireMinimunFields ()
        {
          await RunAsDefaultUserAsync ();
          var command = new GetPlayerClansWithPaginationQuery { PageNumber = 1, PageSize = 10, };
      ...
      public async Task ShouldNotRequireAdministrator ()
        {
          ...
          var command = new GetPlayerClansWithPaginationQuery { ClanId = clanId, PageNumber = 1, PageSize = 10, };
